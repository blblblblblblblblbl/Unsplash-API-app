...
data class PublicUserInfo (
    ...
    @SerializedName("social"             ) var social            : com.blblblbl.myapplication.domain.models.public_user_info.Social?       = com.blblblbl.myapplication.domain.models.public_user_info.Social(),
    @SerializedName("profile_image"      ) var profileImage      : com.blblblbl.myapplication.domain.models.public_user_info.ProfileImage? = com.blblblbl.myapplication.domain.models.public_user_info.ProfileImage(),
    @SerializedName("badge"              ) var badge             : com.blblblbl.myapplication.domain.models.public_user_info.Badge?        = com.blblblbl.myapplication.domain.models.public_user_info.Badge(),
    @SerializedName("links"              ) var links             : com.blblblbl.myapplication.domain.models.public_user_info.Links?        = com.blblblbl.myapplication.domain.models.public_user_info.Links()
