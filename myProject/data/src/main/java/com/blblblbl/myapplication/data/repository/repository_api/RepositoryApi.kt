...
interface RepositoryApi {
    ...
    suspend fun getPublicUserInfo(username: String): com.blblblbl.myapplication.domain.models.public_user_info.PublicUserInfo
    suspend fun getLikedPhotosPage(page: Int, username: String): List<Photo>
    suspend fun getPhotoById(id: String): com.blblblbl.myapplication.domain.models.photo_detailed.DetailedPhotoInfo
